...
class BaseOptions(object):
	...
	def __init__(self):
		...
		self.device = None
	def initialize(self):
		self.parser.add_argument('--batch_size',type=int, default=256, help='Batch Size for each iternations')
...
class TrainOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--print_iter', type=int, default=20, help='Invervals to print between iters')
		self.parser.add_argument('--iter', type=int, default=200, help='Number of interations per epoch')
