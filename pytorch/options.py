...
class BaseOptions(object):
	...
	def __init__(self):
		...
		self.device = None
	def initialize(self):
		self.parser.add_argument('--batch_size',type=int, default=64	, help='Batch Size for each iternations')
...
class TrainOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--lambda_sample', type=float, default=0.25, help='Loss effected by true images')
		self.parser.add_argument('--lambda_target', type=float, default=0.25, help='Loss effected by fake images')
		self.parser.add_argument('--lambda_mmd', type=float, default=1.0, help='MMD Loss percentage')
		self.parser.add_argument('--print_iter', type=int, default=2, help='Invervals to print between iters')
		self.parser.add_argument('--iter', type=int, default=50, help='Number of interations per epoch')
